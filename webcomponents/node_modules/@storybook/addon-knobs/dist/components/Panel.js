...
function (_PureComponent) {
  ...
  function KnobPanel(props) {
    var _this;

    _classCallCheck(this, KnobPanel);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(KnobPanel).call(this, props));
        ...
        Object.keys(knobs).forEach(function (name) {
          ...
          if (!_this.loadedFromUrl) {
            ...
            if (urlValue !== undefined) {
              var value = _types["default"][knob.type].deserialize(urlValue);

              knob.value = value;
              queryParams["knob-".concat(name)] = _types["default"][knob.type].serialize(value);
    ...
    _this.handleChange = function (changedKnob) {
      ...
      _this.setState({
        ...
        Object.keys(newKnobs).forEach(function (n) {
          var knob = newKnobs[n];
          queryParams["knob-".concat(n)] = _types["default"][knob.type].serialize(knob.value);
        });
        api.setQueryParams(queryParams);
      });
    };
